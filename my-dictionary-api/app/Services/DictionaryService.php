...
{
    /**
     * Search for a word definition using the external API
     */
    ...
    /**
     * Decode phonetics from API response
     */
    ...
    /**
     * Decode meanings from API response
     */
    ...
    /**
     * Merge same speech data from multiple results
     */
